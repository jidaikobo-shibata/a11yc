...
define('A11YC_LANG_CTRL_LABEL_BULK_CHECK_ALL', 'Check All');
define('A11YC_LANG_CTRL_DELETE_DONE', 'delete %s');
define('A11YC_LANG_CTRL_PURGE_DONE', 'purge %s');
define('A11YC_LANG_CTRL_UNDELETE_DONE', 'undelete %s');
define('A11YC_LANG_CTRL_DELETE_FAILED', 'Failed to delete %s');
define('A11YC_LANG_CTRL_PURGE_FAILED', 'Failed to purge %s');
define('A11YC_LANG_CTRL_UNDELETE_FAILED', 'Failed to undelete %s');
define('A11YC_LANG_CTRL_ALREADY_EXISTS', 'Already exists');
define('A11YC_LANG_CTRL_ADDED_NORMALLY', 'Add');
define('A11YC_LANG_CTRL_ADD_FAILED', 'Failed');
define('A11YC_LANG_CTRL_DONE', 'Done');
...
define('A11YC_LANG_CTRL_CREATED_AT', 'Add Date');
define('A11YC_LANG_CTRL_LABEL_EDIT', 'Edit');
...
define('A11YC_LANG_SETTING_TITLE_VERSION', 'Versions');
define('A11YC_LANG_SETTING_TITLE_VERSION_EXP', 'You can name the version. Check '.A11YC_LANG_CTRL_PURGE.' and send it completely to delete that version. Please note that you can not recover. If you do not want general display, please uncheck '.A11YC_LANG_CTRL_VIEW);
...
define('A11YC_LANG_DOC_EACH_SUBTITLE', 'About "%s"');
...
define('A11YC_LANG_RESULT_NEWEST_VERSION', 'Newest version');
...
// issues
define('A11YC_LANG_ISSUE_TITLE', 'Issue');
define('A11YC_LANG_ISSUE_TITLE_EACH', 'Name of Issue');
define('A11YC_LANG_ISSUE_ADD', 'Add Issue');
define('A11YC_LANG_ISSUE_EDIT', 'Edit Issue');
...
define('A11YC_LANG_SITECHECK_WITHOUT_HREF', 'Missing a element of href attribute value');
