...
?>
	...
	foreach ($each_pages as $v):
		...
		$alt_url = '';
		if ( ! empty($v['alt_url'])):
			$alt_url = '<div class="a11yc_disclosure_alt_url">'.sprintf(A11YC_LANG_ALT_URL_LEVEL, Util::s(Util::urldec($v['alt_url']))).'</div>';
		endif;
	...
	<tr>
		...
		<td class="a11yc_result"><?php echo Evaluate::result_str($v['level'], $setup['target_level']).$alt_url ?></td>
