...
<?php if (Auth::auth() && isset($login_user[2])): ?>
	<div id="a11yc_menu_wrapper">
		...
		<ul>
			...
			<li class="a11yc_menu_item a11yc_issues"><a href="?c=issues&amp;a=index" class="a11yc_hasicon"><span class="a11yc_fa_icon" role="presentation" aria-hidden="true"></span><?php echo A11YC_LANG_ISSUES_TITLE ?></a></li>
