...
<?php if (\Kontiki\Auth::auth() && isset($login_user[2])): ?>
	<div id="a11yc_menu_wrapper">
		...
		<ul>
			...
			<li class="a11yc_menu_item a11yc_logout a11yc_fr"><a href="?c=auth&amp;a=logout" class="a11yc_hasicon" title="<?php echo A11YC_LANG_LOGOUT ?>"><?php echo $login_user[2].'&nbsp;' ?><span class="a11yc_fa_icon" role="presentation" aria-hidden="true"></span></a></li>
