...
<tr>
	...
	<td><?php echo $users[$issue['uid']] ?></td>
</tr>
...
<div id="a11yc_submit">
	...
	<?php if ($issue['uid'] == $current_user['id'] || $current_user[0] == 'root'): ?>
	<a href="<?php echo A11YC_ISSUES_EDIT_URL.intval($issue['id']) ?>"><?php echo A11YC_LANG_ISSUES_EDIT  ?></a>
	<?php endif; ?>
