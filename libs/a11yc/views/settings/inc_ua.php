<?php namespace A11yc; ?>
<h2><?php echo A11YC_LANG_SETTINGS_TITLE_UA ?></h2>
<p><?php echo A11YC_LANG_SETTINGS_TITLE_UA_EXP ?></p>
...
?>
	...
	<td style="width:5em; text-align: center;">
		<label><input<?php echo $disabled ?> type="checkbox" name="delete[<?php echo $id ?>]" id="delete_<?php echo $id ?>" value="<?php echo $id ?>"><span class="a11yc_skip"><?php echo A11YC_LANG_PAGES_PURGE.' ('.Util::s($ua['name']).')' ?></span></label>
	</td>
	</tr>
