...
define('A11YC_LANG_PAGES_URLS_ADD_FORCE', '実在の有無にかかわらず強制的に追加する');
...
define('A11YC_LANG_PAGES_CREATED_AT', '登録日');
define('A11YC_LANG_PAGES_ORDER_CREATED_AT_ASC', '登録日昇順');
define('A11YC_LANG_PAGES_ORDER_CREATED_AT_DESC', '登録日降順');
...
define('A11YC_LANG_PAGES_ORDER_TITLE_ASC', 'ページ名昇順');
define('A11YC_LANG_PAGES_ORDER_TITLE_DESC', 'ページ名降順');
define('A11YC_LANG_PAGES_ORDER_SEQ', '表示順');
define('A11YC_LANG_PAGES_ORDER_SEQ_ASC', '表示順昇順');
define('A11YC_LANG_PAGES_ORDER_SEQ_DESC', '表示順降順');
...
define('A11YC_LANG_SETTINGS_TITLE_UA_EXP', '一番最後の空行に入力することで、UAを追加できます。「'.A11YC_LANG_PAGES_PURGE.'」をチェックして送信するとユーザエージェントを削除します。「'.A11YC_LANG_UA_USING.'」は名称以外編集も削除もできません。');
...
define('A11YC_LANG_CHECKLIST_DO_CSS_CHECK', '外部CSSをチェック');
...
define('A11YC_LANG_RESULTS_NEWEST_VERSION', '最新版');
define('A11YC_LANG_RESULTS_CHANGE_VERSION', '方針・報告書・試験の版を切り替える');
define('A11YC_LANG_RESULTS_VERSION_NOT_FOUND', '指定された版が見つかりませんでした');
define('A11YC_LANG_RESULTS_PROTECT_VERSION_TITLE', 'データの保護');
define('A11YC_LANG_RESULTS_PROTECT_VERSION_EXP', '現在の方針、試験、報告を保護します。保護されたデータは編集対象外になります。保護されたデータは、アクセシビリティ方針を表示する際、選択して閲覧できるようになります。保護は日単位です。本日のデータがある場合は上書きします');
define('A11YC_LANG_RESULTS_DELETE_SAMEDATE', '本日作成の保護されたデータがあったため上書きしました');
define('A11YC_LANG_RESULTS_PROTECT_DATA_SAVED', 'データを保護しました');
define('A11YC_LANG_RESULTS_PROTECT_DATA_FAILD', 'データの保護に失敗しました');
define('A11YC_LANG_RESULTS_PROTECT_DATA_CONFIRM', '本当にデータを保護してよいですか？');
define('A11YC_LANG_RESULTS_VERSION_EXISTS', '存在するバージョン');
define('A11YC_LANG_RESULTS_PASSED_CHECKITEM', '達成しているチェック項目');
...
define('A11YC_LANG_ISSUES_IS_COMMON', 'サイト内で共通の問題');
define('A11YC_LANG_ISSUES_HTML', '問題箇所のHTML片');
define('A11YC_LANG_ISSUES_HTML_EXP', '問題箇所のHTML片を入力すると、レポート等に表示されます。HTMLにはコメントアウト部分、scriptの内部等は含めることができません');
define('A11YC_LANG_ISSUES_N_OR_E', 'Notice/Error');
define('A11YC_LANG_ISSUES_N_OR_E_EXP', 'Notice（注意喚起）かError（明確な問題）か選択してください');
define('A11YC_LANG_ISSUES_TECH', '達成方法集のURL');
define('A11YC_LANG_ISSUES_TECH_EXP', 'WCAG 2.0 達成方法集のURLを入力してください。複数存在する場合は改行で区切ってください');
define('A11YC_LANG_ISSUES_STATUS', '対応状況');
...
define('A11YC_LANG_ISSUES_EDITED_FAILED', '問題点の編集に失敗しました');
...
define('A11YC_LANG_POST_HOWTO', '<p>HTMLに対して、機械的にできるアクセシビリティのチェックを行います。<a href="%s">アクセシビリティチェック</a>の<code>URL</code>に検査対象のURLを入力するか、<code>HTML Source</code>のtextareaにHTMLを貼付して、送信してください。アクセシビリティ上のチェックポイントとその解説文を表示します。</p><p>URLによるチェックの場合は、アクセシビリティのチェックの他に、画像とaltの確認を行うことができます。</p>');
...
define('A11YC_LANG_POST_TECH_JWP_A11YC_ADD', 'Wordpressプラグイン版では、このA11yc ACS'.A11YC_LANG_POST_SERVICE_NAME_ABBR.'のバリデーション機能を投稿のたびに実行できるので、恒常的にアクセシビリティを意識してサイトを運営できるようになると思います');
