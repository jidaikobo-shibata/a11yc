...
define('A11YC_LANG_CHECKLIST_MACHINE_CHECK_DONE', '機械判定しました');
define('A11YC_LANG_CHECKLIST_MACHINE_CHECK_FAILED', '機械判定で不適合');
define('A11YC_LANG_CHECKLIST_MACHINE_CHECK_PASSED', '機械判定を通過');
define('A11YC_LANG_CHECKLIST_MACHINE_CHECK_EXIST', '機械判定では適用あり');
