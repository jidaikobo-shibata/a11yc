...
define('A11YC_LANG_PAGES_ORDER_SEQ', 'Order');
define('A11YC_LANG_PAGES_ORDER_SEQ_ASC', 'Order Asc.');
define('A11YC_LANG_PAGES_ORDER_SEQ_DESC', 'Order Desc.');
...
define('A11YC_LANG_PAGES_LABEL_EXPORT_CHECK_RESULT', 'Export test results for merging');
define('A11YC_LANG_EXPORT_TITLE', 'Export &ampl Import');
define('A11YC_LANG_PAGES_LABEL_IMPORT_CHECK_RESULT', 'Import test results and merge');
define('A11YC_LANG_PAGES_LABEL_EXPORT_CHECK_RESULT_EXP', 'Export "checklist" and "issue". Copy all the character string outputted to textarea below and paste it on the textarea displayed in "'.A11YC_LANG_PAGES_LABEL_IMPORT_CHECK_RESULT.'" in the target environment.');
define('A11YC_LANG_PAGES_LABEL_IMPORT_CHECK_RESULT_EXP', 'I will import "checklist" and "issue". Please paste the result obtained by "'.A11YC_LANG_PAGES_LABEL_EXPORT_CHECK_RESULT.'" to textarea.');
