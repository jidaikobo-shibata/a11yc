...
class Validate_Link extends Validate
{
	 ...
	 * @return Void
	 */
	public static function notice_non_html_exists()
	{
		...
		if ($exists)
		{
			...
			static::$error_ids['notice_non_html_exists'][0]['id'] = 0;
			static::$error_ids['notice_non_html_exists'][0]['str'] = join(', ', $err_strs);
		}
		static::add_error_to_html('notice_non_html_exists', static::$error_ids, 'ignores');
	}
